Maktoub.from = "ChattyHive Team <chattyhive@gmail.com>" # the email the newsletter is sent from
Maktoub.twitter_url = "http://twitter.com/chattyhive" # your twitter page
Maktoub.facebook_url = "http://www.facebook.com/facebook" # your facebook oage
Maktoub.subscription_preferences_url = "http://chattyhive.com/manage_subscriptions" #subscribers management url
Maktoub.logo = "logo1.jpg" # path to your logo asset
Maktoub.home_domain = "chattyhive.com" # your domain
Maktoub.app_name = "ChattyHive" # your app name
